...
public class DummyLog extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = org.apache.avro.Schema.parse("{\"type\":\"record\",\"name\":\"DummyLog\",\"namespace\":\"com.linkedin.camus.example\",\"doc\":\"Logs for not so important stuff.\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"logTime\",\"type\":\"long\"},{\"name\":\"muchoStuff\",\"type\":{\"type\":\"map\",\"values\":\"string\"}}]}");
  ...
  public static com.linkedin.camus.example.DummyLog.Builder newBuilder() {
    return new com.linkedin.camus.example.DummyLog.Builder();
  }
  
  /** Creates a new DummyLog RecordBuilder by copying an existing Builder */
  public static com.linkedin.camus.example.DummyLog.Builder newBuilder(com.linkedin.camus.example.DummyLog.Builder other) {
    return new com.linkedin.camus.example.DummyLog.Builder(other);
  }
  
  /** Creates a new DummyLog RecordBuilder by copying an existing DummyLog instance */
  public static com.linkedin.camus.example.DummyLog.Builder newBuilder(com.linkedin.camus.example.DummyLog other) {
    return new com.linkedin.camus.example.DummyLog.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DummyLog>
    ...
    private Builder() {
      super(com.linkedin.camus.example.DummyLog.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.linkedin.camus.example.DummyLog.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing DummyLog instance */
    private Builder(com.linkedin.camus.example.DummyLog other) {
            super(com.linkedin.camus.example.DummyLog.SCHEMA$);
    ...
    /** Sets the value of the 'id' field */
    public com.linkedin.camus.example.DummyLog.Builder setId(long value) {
    ...
    public com.linkedin.camus.example.DummyLog.Builder clearId() {
    ...
    /** Sets the value of the 'logTime' field */
    public com.linkedin.camus.example.DummyLog.Builder setLogTime(long value) {
    ...
    public com.linkedin.camus.example.DummyLog.Builder clearLogTime() {
    ...
    /** Sets the value of the 'muchoStuff' field */
    public com.linkedin.camus.example.DummyLog.Builder setMuchoStuff(java.util.Map<java.lang.CharSequence,java.lang.CharSequence> value) {
    ...
    public com.linkedin.camus.example.DummyLog.Builder clearMuchoStuff() {
      muchoStuff = null;
