...
public class DummyLog2 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = org.apache.avro.Schema.parse("{\"type\":\"record\",\"name\":\"DummyLog2\",\"namespace\":\"com.linkedin.camus.example\",\"doc\":\"Logs for really important stuff.\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"muchoStuff\",\"type\":{\"type\":\"map\",\"values\":\"string\"}}]}");
  ...
  public static com.linkedin.camus.example.DummyLog2.Builder newBuilder() {
    return new com.linkedin.camus.example.DummyLog2.Builder();
  }
  
  /** Creates a new DummyLog2 RecordBuilder by copying an existing Builder */
  public static com.linkedin.camus.example.DummyLog2.Builder newBuilder(com.linkedin.camus.example.DummyLog2.Builder other) {
    return new com.linkedin.camus.example.DummyLog2.Builder(other);
  }
  
  /** Creates a new DummyLog2 RecordBuilder by copying an existing DummyLog2 instance */
  public static com.linkedin.camus.example.DummyLog2.Builder newBuilder(com.linkedin.camus.example.DummyLog2 other) {
    return new com.linkedin.camus.example.DummyLog2.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DummyLog2>
    ...
    private Builder() {
      super(com.linkedin.camus.example.DummyLog2.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.linkedin.camus.example.DummyLog2.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing DummyLog2 instance */
    private Builder(com.linkedin.camus.example.DummyLog2 other) {
            super(com.linkedin.camus.example.DummyLog2.SCHEMA$);
    ...
    /** Sets the value of the 'id' field */
    public com.linkedin.camus.example.DummyLog2.Builder setId(long value) {
    ...
    public com.linkedin.camus.example.DummyLog2.Builder clearId() {
    ...
    /** Sets the value of the 'name' field */
    public com.linkedin.camus.example.DummyLog2.Builder setName(java.lang.CharSequence value) {
    ...
    public com.linkedin.camus.example.DummyLog2.Builder clearName() {
      name = null;
    ...
    /** Sets the value of the 'muchoStuff' field */
    public com.linkedin.camus.example.DummyLog2.Builder setMuchoStuff(java.util.Map<java.lang.CharSequence,java.lang.CharSequence> value) {
    ...
    public com.linkedin.camus.example.DummyLog2.Builder clearMuchoStuff() {
      muchoStuff = null;
