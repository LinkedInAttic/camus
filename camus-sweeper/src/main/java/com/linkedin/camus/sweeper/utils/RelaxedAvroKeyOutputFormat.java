...
public class RelaxedAvroKeyOutputFormat<T> extends AvroKeyOutputFormat<T> 
{
  private static final Log LOG =
    LogFactory.getLog(RelaxedAvroKeyOutputFormat.class.getName());
  ...
  public RecordWriter<AvroKey<T>, NullWritable> getRecordWriter(TaskAttemptContext context)
    ...
    Schema writerSchema  = schemaString != null ? RelaxedSchemaUtils.parseSchema(schemaString, context.getConfiguration()) : null;
