...
public class EtlMultiOutputFormat extends FileOutputFormat<EtlKey, Object> {
	...
	public RecordWriter<EtlKey, AvroWrapper<Object>> getDataRecordWriter(TaskAttemptContext context, String name, String schema) throws IOException,
	...
	class MultiEtlRecordWriter extends RecordWriter<EtlKey, Object> {
		...
		public MultiEtlRecordWriter(TaskAttemptContext context) throws IOException, InterruptedException {
			...
			errorWriter = SequenceFile.createWriter(FileSystem.get(context.getConfiguration()), context.getConfiguration(), new Path(committer.getWorkPath(),
					getUniqueFile(context, ERRORS_PREFIX, "")), EtlKey.class, ExceptionWritable.class);
	...
	public class EtlMultiOutputCommitter extends FileOutputCommitter {
		...
		public void commitTask(TaskAttemptContext context) throws IOException {
			...
			SequenceFile.Writer offsetWriter = SequenceFile.createWriter(fs, context.getConfiguration(),
					new Path(super.getWorkPath(), getUniqueFile(context, OFFSET_PREFIX, "")), EtlKey.class, NullWritable.class);
