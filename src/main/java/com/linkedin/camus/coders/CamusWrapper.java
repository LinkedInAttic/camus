...
/**
 * Container for messages. Enables the use of a custom message decoder with
 * knowledge of where these values are stored in the message schema
 *
 * @author kgoodhop
 *
 * @param <R>
 *            The type of decoded payload
 */
