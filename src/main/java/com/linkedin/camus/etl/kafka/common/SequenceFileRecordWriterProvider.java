...
public class SequenceFileRecordWriterProvider implements RecordWriterProvider {
	...
	public RecordWriter<IEtlKey, CamusWrapper<String>> getDataRecordWriter(
			...
			CamusWrapper<String> camusWrapper, FileOutputCommitter committer)
		...
		log.info("Creating new SequenceFile.Writer with compression type "
				...
				+ (compressionCodec != null ? compressionCodec.getClass()
						.getName() : "null"));
		...
		return new RecordWriter<IEtlKey, CamusWrapper<String>>() {
			@Override
			public void write(IEtlKey key, CamusWrapper<String> data)
					throws IOException, InterruptedException {
